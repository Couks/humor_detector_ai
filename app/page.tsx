    ...
    <main className="flex flex-col w-screen h-screen items-center bg-zinc-100">
      ...
      <div className="flex w-auto h-auto m-12">
        <div className="flex flex-col">
          ...
          <Button
            onClick={removeImage}
            className="text-white font-bold bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 focus:outline-none rounded-lg p-4"
          >
            Enviar Imagem
          </Button>
          {imagePreview && (
            <Button
              onClick={removeImage}
              className="text-white font-bold bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 focus:outline-none rounded-lg p-4 mt-4"
            >
