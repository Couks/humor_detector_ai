...
export function InputImage() {
  ...
  const [imagePreview, setImagePreview] = useFormState(false);
  ...
  return (
      <>
        <div className="flex flex-col w-full h-full items-center p-4 sm:px-60 ">
          {imagePreview && (
            <div className="max-w-96 p-6 mb-4 bg-gray-100 border-dashed border-purple-500 border-2 rounded-lg items-center mx-20 text-center cursor-pointer">
              <img
                src={imagePreview}
                alt="Image preview"
