...
export default function Header({
  ...
  return (
    <header className="flex h-20 w-full items-center justify-around px-8 bg-white shadow-xl rounded-xl">
      <Link href="/">
        <Image
          src={logo}
      ...
      <h1 className="sm:hidden md:block text-xl font-bold m text-purple-400 font-mono ">
        {title}
      </h1>
